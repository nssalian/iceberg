...
public class BenchmarkMetricsReporter implements MetricsReporter {
  ...
  private final List<ScanReport> scanReports = Collections.synchronizedList(new ArrayList<>());
  private final List<CommitReport> commitReports = Collections.synchronizedList(new ArrayList<>());
